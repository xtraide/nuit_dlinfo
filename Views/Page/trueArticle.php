...
<body>
  <section class="trueArticle">
    ...
    <section class="chapeau"><br>
      ...
      <div class="container">
        ...
        <div class="container_intro">
          ...
          <div class="image_intro"><img src="../Template/assets/img/ours-pollution.png" alt=""></div>
    ...
    <section>
      <h2>Prédictions de la température gloabele de la surface de la Terre</h2>
      ...
      <script>
        ...
        const myChart = new Chart(ctx, {
          ...
          options: {
            scales: {
              x: {
                type: 'category', // Utiliser une échelle de catégorie pour les années
                position: 'bottom',
                title: {
                  display: true,
                  text: 'Année'
